...
function makePopUp(event){
    ...
    let popUpBodyText = "<h1 class='PopUpBodyText'>Escolha a cor</h1>";
    ...
    let normal = "<button onclick=chooseDifficulty(2) class='ChooseSideButton DifficultyButton'> Iniciante </button>";
    let tough = "<button onclick=chooseDifficulty(3) class='ChooseSideButton DifficultyButton' autofocus> Médio </button>";
    let hard = "<button onclick=chooseDifficulty(4) class='ChooseSideButton DifficultyButton'> Difícil (Lento) </button>";

    let themeText = "<h2 class='PopUpBodyText' style='margin-top: 8px;'>Tema</h2>";
    ...
    let br = "<br>";
    let viewBoard = "<button onclick=viewBoard() class='viewBoardButton' > Tabuleiro </button>";
